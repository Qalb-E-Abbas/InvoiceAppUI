...
class SignUpBusinessLogic with ChangeNotifier {
  ...
  late BusinessModel _validatedUserModel;

  BusinessModel get validatedUser => _validatedUserModel;
  ...
  Future registerNewUser(
      ...
      required BusinessModel userModel,
    ...
    return _authServices
      ...
      if (user != null) {
        ...
        _userServices.addUserData(user, userModel, context);
      } else {
