      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(price,style: TextStyle(color: Colors.black,fontSize: 14,fontWeight: FontWeight.w500),),
            SizedBox(
              height: 10,
            ),
            Text(price2,style: TextStyle(color: Colors.black,fontSize: 14,fontWeight: FontWeight.w500),),
