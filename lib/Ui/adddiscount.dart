      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Utiles.getStyledTextField(controller: _prcntController, hint: "Enter Percentage", isNumber: false),
            SizedBox(
              height: 20,
            ),
            Padding(
              ...
              child: SizedBox(
                ...
                child: Padding(
                  ...
                  child: RaisedButton(
                    ...
                    onPressed: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context)=> Invoice2()));
                    },
                  ),
                ),
              ),
